        ...
        while oplista!=11:
            ...
            if oplista==1:
                ...
                for i in range(cantidadele):
                    ...
                    os.system("cls")
                tralista=tratamientolistas(lista)
                valor=str(input("Ingrese el valor que desea agregar/reemplazar en la lista: "))
                posicion=int(input("Ingrese el lugar que desea ingresar el valor [0.....{}] ".format(len(lista)-1)))
                print("La nueva lista es:\n",tralista.insertarlista(valor,posicion))
                input("presione cualquier tecla para continuar...")    
            elif oplista==7:
                tralista=tratamientolistas("")
                tralista.eliminarlista("")
                input("presione cualquier tecla para continuar...")    
            elif oplista==8:
                cantidadele = int(input("Introduce la cantidad de elementos para la lista: "))
                os.system("cls")
